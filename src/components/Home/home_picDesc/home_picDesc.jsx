...
import pic_me_sky from '../../../assets/pic_me_sky.jpg'
import pic_me_cropped from '../../../assets/pic_me_cropped.jpg'
import pig from '../../../assets/pig.jpg'
export default function Home_picDesc(){
    return(
        <div className={styles.main_div}>
            <div className={styles.intro_div}>
                <img className={styles.profile_pic} src={pic_me_sky} alt="pciture of me"/>
